...
class TeacherAdmin(object):
    ...
    search_fields = [ 'org','name', 'work_years', 'work_position', 'points', 'click_nums', 'fav_nums']
    list_filter = ['org__name','name', 'work_years', 'work_position', 'points', 'click_nums', 'fav_nums', 'add_time']
